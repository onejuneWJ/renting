...
public class ResponseData<T> {
    ...
    public ResponseData(int code, String msg, Long count, T data) {
        this.code = code;
        this.msg = msg;
        this.count = count;
        this.data = data;
    ...
    public static <T> ResponseData<T> ok(T data) {
        return ok(data, Constant.SUCCESS);
    }

    public static <T> ResponseData<T> ok(T data, String msg) {
        return new ResponseData<>(CODE_OK, msg, data);
    }
    ...
    public static <T> ResponseData<List<T>> pageOk(PageInfo<T> data) {
        ...
        responseData.setCount(data.getTotal());
        responseData.setMsg(Constant.SUCCESS);
        return responseData;
    }
